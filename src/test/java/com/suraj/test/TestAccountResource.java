 ...
 * <p>
 * INSERT INTO Account (CustomerName,Balance,CurrencyCode) VALUES ('test2',100.0000,'USD'); --ID =1
 * INSERT INTO Account (CustomerName,Balance,CurrencyCode) VALUES ('test1',200.0000,'USD'); --ID =2
 * INSERT INTO Account (CustomerName,Balance,CurrencyCode) VALUES ('test2',500.0000,'EUR'); --ID =3
 * INSERT INTO Account (CustomerName,Balance,CurrencyCode) VALUES ('test1',500.0000,'EUR'); --ID =4
 */

public class TestAccountResource extends TestService {
     ...
     */
    @Test
    public void testGetAccountByCustomerName() throws IOException, URISyntaxException {
        ...
        assertTrue(account.getCustomerName().equals("suraj"));
    }
    ...
    */
    ...
    public void testCreateAccount() throws IOException, URISyntaxException {
        ...
        assertTrue(aAfterCreation.getCustomerName().equals("test2"));
    ...
    */
    ...
    public void testCreateExistingAccount() throws IOException, URISyntaxException {
        URI uri = builder.setPath("/account/create").build();
        Account acc = new Account("suraj", new BigDecimal(100), "USD");
        String jsonInString = mapper.writeValueAsString(acc);
        StringEntity entity = new StringEntity(jsonInString);
        HttpPut request = new HttpPut(uri);
        request.setHeader("Content-type", "application/json");
